...
namespace Microsoft.Samples.Kinect.DiscreteGestureBasics
{
    ...
    /// </summary>
    public sealed class ArmsCrossedResultView : INotifyPropertyChanged
    {
        /// <summary> Image to show when the 'detected' property is true for a tracked body </summary>
        private readonly ImageSource armsCrossedImage = new BitmapImage(new Uri(@"Images\ArmsCrossed.png", UriKind.Relative));

        /// <summary> Image to show when the 'detected' property is false for a tracked body </summary>
        private readonly ImageSource notarmsCrossedImage = new BitmapImage(new Uri(@"Images\NotArmsCrossed.png", UriKind.Relative));
        ...
        public ArmsCrossedResultView(int bodyIndex, bool isTracked, bool detected, double confidence)
        {
        ...
        public void UpdateArmsCrossedResult(bool isBodyTrackingIdValid, bool isGestureDetected, double detectionConfidence)
        {
            ...
            else
            {
                ...
                if (this.Detected)
                {
                    ...
                    this.ImageSource = this.armsCrossedImage;
                    this.BodyColor = this.trackedColors[2];
                }
                else
                {
                    this.ImageSource = this.notarmsCrossedImage;
