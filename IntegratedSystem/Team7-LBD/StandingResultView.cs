...
namespace Microsoft.Samples.Kinect.DiscreteGestureBasics
{
    ...
    /// </summary>
    public sealed class StandingResultView : INotifyPropertyChanged
    {
        /// <summary> Image to show when the 'detected' property is true for a tracked body </summary>
        private readonly ImageSource standingImage = new BitmapImage(new Uri(@"Images\Standing.png", UriKind.Relative));

        /// <summary> Image to show when the 'detected' property is false for a tracked body </summary>
        private readonly ImageSource notStandingImage = new BitmapImage(new Uri(@"Images\NotStanding.png", UriKind.Relative));
        ...
        public StandingResultView(int bodyIndex, bool isTracked, bool detected, double confidence)
        {
        ...
        public void UpdateStandingResult(bool isBodyTrackingIdValid, bool isGestureDetected, double detectionConfidence)
        {
            ...
            else
            {
                ...
                {
                    this.ImageSource = this.notStandingImage;
