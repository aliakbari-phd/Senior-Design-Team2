...
namespace AHRS
{
    ...
    {
        static FileStream aFile = new FileStream("quternion.txt ", FileMode.OpenOrCreate);
        ...
        /// Total sqrt: 5
        /// </remarks> 
        public void Update(float gx, float gy, float gz, float ax, float ay, float az, float mx, float my, float mz, float time)
        {
            ...
            float time_duration = (float)0.005;

            // Integrate to yield quaternion
            q1 += qDot1 * time_duration;
            q2 += qDot2 * time_duration;
            q3 += qDot3 * time_duration;
            q4 += qDot4 * time_duration;
           ...
           // string text = Quaternion[0] + " " + Quaternion[1] + " " + Quaternion[2] + " " + Quaternion[3];
           // sw.WriteLine(text);
        }
