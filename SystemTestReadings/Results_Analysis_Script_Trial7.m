%%%%%%%%%%%%%%%%%%%%%%%%%%%%  VICON  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
filename = 'Ben_Johnston Cal 08.csv';
V_Data = xlsread(filename, 'A12:N1584');
...
filenameSMid = 'T8S1.txt';
filenameSBase = 'T8S2.txt';
delimiterIn = ' ';
headerlinesIn_IMU = 1;
...
filename1_Kin = 'spinebaseT8.txt';
filename2_Kin = 'spinemidT8.txt';
delimiterIn = ' ';
headerlinesIn_Kin = 0;
