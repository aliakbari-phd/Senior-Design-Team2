...
clear;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%  VICON  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
filename = 'Ben_Johnston Cal 10.csv';
V_Data = xlsread(filename, 'A11:N1556');
...
filenameSMid = 'T10S1.txt';
filenameSBase = 'T10S2.txt';
delimiterIn = ' ';
headerlinesIn_IMU = 1;
...
positionMid = trapz(tMid(1:3091),gyroMid);
distanceMid = cumtrapz(tMid(1:3091),gyroMid);     % vel to distance
...
%%%%% Kinect %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
filename1_Kin = 'spinebaseT10.txt';
filename2_Kin = 'spinemidT10.txt';
delimiterIn = ' ';
headerlinesIn_Kin = 0;
