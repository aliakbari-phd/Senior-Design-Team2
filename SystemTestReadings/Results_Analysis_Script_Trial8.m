%%%%%%%%%%%%%%%%%%%%%%%%%%%%  VICON  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
filename = 'Ben_Johnston Cal 09.csv';
V_Data = xlsread(filename, 'A12:N1585');
...
filenameSMid = 'T9S1.txt';
filenameSBase = 'T9S2.txt';
delimiterIn = ' ';
headerlinesIn_IMU = 1;
...
filename1_Kin = 'spinebaseT9.txt';
filename2_Kin = 'spinemidT9.txt';
delimiterIn = ' ';
headerlinesIn_Kin = 0;
