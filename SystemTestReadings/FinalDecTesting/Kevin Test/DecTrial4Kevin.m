...
clear;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%  VICON  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
filename = 'Ben_Johnston Cal 26.csv';
V_Data = xlsread(filename, 'A6:N1729');
...
%Syncing
[Vic_pks, Vic_locs] = findpeaks(alpha_deg, 'MinPeakProminence', 1);
...
kin_filter = designfilt('lowpassiir','FilterOrder',3,...
            'PassbandFrequency',2e3,'PassbandRipple',0.5,...
            'SampleRate',200e3);

alpha_deg_Kin_filt = filtfilt(kin_filter, alpha_deg_Kin);

[Kin_pks , Kin_locs] = findpeaks(alpha_deg_Kin, 'MinPeakProminence', .1);
...
[Kin_peaks, Kin_locations] = findpeaks(Kin_plot_y, 'MinPeakProminence', .1);
